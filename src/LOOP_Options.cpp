...
void LOOP_Options()
{
  ...
  while(!QuitProgram && !QuitToMenu)
  {
    ...
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 4) {AUDIO_Volume_Change_Music(VolumePercentage_Music += 10, true); AUDIO_Sound_Play(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 5) {AUDIO_Volume_Change_Music(VolumePercentage_Music -= 10, true); AUDIO_Sound_Play(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 6) {AUDIO_Volume_Change_Sound(VolumePercentage_Sound += 10, true); AUDIO_Sound_Play(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 7) {AUDIO_Volume_Change_Sound(VolumePercentage_Sound -= 10, true); AUDIO_Sound_Play(Audio::AudioTypeEnum::AUDIO_CLICK);}
